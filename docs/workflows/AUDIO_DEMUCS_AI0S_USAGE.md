...
The adapter decodes the source and verified stems through the pinned native runtime dependency lane and computes:
...
The metrics step fails closed if required evidence dependencies are unavailable or decoded shape/rate/duration facts disagree.
